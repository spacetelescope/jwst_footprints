...
def rollangle(ra, dec):
        ...
        #print "   Start[MJD]      End[MJD]    Duration         Start         End       coord1        coord2"
                ...
                if iflag:
                    ...
                    if twstart > 0.:
                        ...
                        if pa == "X":
                            ...
                            pa_start = pa
                            pa_end = pa
                       # print "%13.5f %13.5f %11.2f %13.5f %13.5f %13.5f %13.5f " % (wstart,wend,wend-wstart,pa_start*R2D,pa_end*R2D,ra*R2D,dec*R2D)
                iflag_old = iflag
        ...
        if iflip == True and iflag == True:
            if pa == "X":
                ...
                pa_start = pa
                pa_end = pa
        #    print "%13.5f %13.5f %11.2f %13.5f %13.5f %13.5f %13.5f " % (twstart,adate,adate-twstart,pa_start*R2D,pa_end*R2D,ra*R2D,dec*R2D)
