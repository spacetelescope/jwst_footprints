...
def pa(tgt_c1, tgt_c2, obj_c1, obj_c2):
    ...
    x = (sin(obj_c2) * cos(tgt_c2) - cos(obj_c2) *
         sin(tgt_c2) * cos(obj_c1 - tgt_c1))
    p = atan2(y, x)
    if p < 0.:
        p += PI2
    if p >= PI2:
...
def delta_pa_no_roll(pos1_c1, pos1_c2, pos2_c1, pos2_c2):
    ...
    v = cos(pos2_c1 - pos1_c1) + cos(pos1_c2) * cos(pos2_c2) + \
        sin(pos1_c2) * sin(pos2_c2) * cos(pos2_c1 - pos1_c1)
    return atan2(u, v)
...
def dist(obj1_c1, obj1_c2, obj2_c1, obj2_c2):
    ...
    x = cos(obj2_c2) * cos(obj1_c2) * cos(obj2_c1 -
                                          obj1_c1) + sin(obj2_c2) * sin(obj1_c2)
