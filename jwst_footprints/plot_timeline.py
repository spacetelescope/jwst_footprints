...
def plottimeline(ra_msa='202.47',
    ...
    data = ascii.read(os.path.join(outdir, 'v3pa_nircam_nirspec.txt'))
    ...
    plt.plot_date(timeplot, maxnirspec, color='firebrick',
                  marker='.', markersize=2)
    plt.plot_date(timeplot, minnirspec, color='firebrick',
                  marker='.', markersize=2)
